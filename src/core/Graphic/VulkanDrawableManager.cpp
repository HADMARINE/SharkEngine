...
////    for (size_t i = 0; i < VULKAN_CORE->GetCommandBuffer().size(); i++) {
////        VkCommandBufferBeginInfo beginInfo{};
////        beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
////        beginInfo.flags = 0;
////        beginInfo.pInheritanceInfo = nullptr;
////
////        if (vkBeginCommandBuffer(VULKAN_CORE->GetCommandBuffer()[i], &beginInfo) != VK_SUCCESS) {
...
////        renderPassInfo.renderPass = VULKAN_CORE->GetRenderPass();
////        renderPassInfo.framebuffer = VULKAN_CORE->GetSwapChainFrameBuffer()[i];
////        renderPassInfo.renderArea.offset = {0, 0};
////        renderPassInfo.renderArea.extent = VULKAN_CORE->GetSwapChainExtent();
////
...
////
////        vkCmdBeginRenderPass(VULKAN_CORE->GetCommandBuffer()[i],
////                             &renderPassInfo,
////                             VK_SUBPASS_CONTENTS_INLINE);
////
////        vkCmdBindPipeline(VULKAN_CORE->GetCommandBuffer()[i],
////                          VK_PIPELINE_BIND_POINT_GRAPHICS,
////                          VULKAN_CORE->GetGraphicPipeline());
////
////        //Draw Indexed!! -----------------------
////        //--------------------------------------
////
////        vkCmdEndRenderPass(VULKAN_CORE->GetCommandBuffer()[i]);
////
////        if (vkEndCommandBuffer(VULKAN_CORE->GetCommandBuffer()[i]) != VK_SUCCESS) {
